...
-- Designlerret: dokumentet en design-chat eier.
ALTER TABLE chats ADD COLUMN IF NOT EXISTS design_slug text NOT NULL DEFAULT '';

-- Designarbeidsområdet: hvilke dokumenter som ligger hvor på boardet.
