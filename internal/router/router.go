...
const (
	...
	TopModel   = MidModel
	LightModel = MidModel
	// VisionModel tolker bilder. MÅLT 2026-08-02: pixtral er ute av
	// Mistral-katalogen; mistral-large-2512 GODTAR bilder men ser dem ikke
	// (0/3 på fargetest — svarte «hvit» på alt), mistral-medium-2604 traff
	// 3/3. Medium 3.5 er katalogverifisert multimodal og eier bildeturene.
	VisionModel = "mistral-medium-2604"
)
